...
public class CustomAdapterLTCTheoGV extends ArrayAdapter {
    Context context;
    int resource;
    List<LopTinChiTheoGV> data;

    public CustomAdapterLTCTheoGV(@NonNull Context context, int resource, @NonNull List<LopTinChiTheoGV> data) {
